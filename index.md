...
py5 is a new version of [Processing][processing] for Python 3.10+. The goal of py5
...
* **imported mode**: simplified code that omits the `py5.` prefix. This mode is supported by the py5 Jupyter notebook kernel and the `py5-run-sketch` command line utility. The above example is created in imported mode.
